...
class AppTheme {
  ...
  // Brand Colors
  static const Color primaryColor = Color(0xFFE53935); // Dota 2 red
  ...
  // Status Colors
  static const Color statusLive = Color(0xFFE53935);
  static const Color statusUpcoming = Color(0xFF43A047);
